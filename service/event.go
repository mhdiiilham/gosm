...
func (s *EventService) SetGuestIsArrived(ctx context.Context, guestShortID string, isArrived bool) (err error) {
	return s.eventRepository.SetGuestIsArrived(ctx, guestShortID, isArrived)
}
